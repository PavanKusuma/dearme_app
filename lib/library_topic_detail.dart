...
class LibraryTopicDetail extends StatefulWidget {
  final Feeling feeling;

  LibraryTopicDetail({required this.feeling});

  @override
  LibraryTopicDetailState createState() => LibraryTopicDetailState();
}

class LibraryTopicDetailState extends State<LibraryTopicDetail> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<LibraryTopicDetail> {
...
// print(Provider.of<SharedState>(context).isDataLoaded);
  ...
  void getFeelingData() async {
    ...
    if(await checkInternetConnectivity()){
      ...
      var result = await get(Uri.parse(APIUrls.getUrl("${APIUrls.feelings}${APIUrls.pass}/$role/$offset/FEELING/${widget.feeling.feeling}", queryParams)), headers: {"Accept": "application/json"});
      // print(result.body);
...
// Example HTML string
    ...
    TextSpan htmlToTextSpan(String html) {
      ...
      exp.allMatches(html).forEach((match) {
        ...
        if (boldText != null) {
          final String cleanText = boldText.replaceAll(RegExp(r'<\/?b>'), '');
          spans.add(TextSpan(text: cleanText, style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium, fontWeight: FontWeight.bold)));
        } else if (italicText != null) {
          final String cleanText = italicText.replaceAll(RegExp(r'<\/?i>'), '');
          spans.add(TextSpan(text: cleanText, style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium, fontStyle: FontStyle.italic)));
        } else if (normalText != null) {
          spans.add(TextSpan(text: normalText));
        }
      });
      return TextSpan(children: spans, style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium));
    }
      ...
      SafeArea(
        ...
        child: Column(
          ...
          children: <Widget>[
                  ...
                  Column(
                    ...
                    children: [ 
                      Row(
                        ...
                        children: [
                        Text(widget.feeling.emotion!, style: GoogleFonts.caveat(textStyle: Theme.of(context).textTheme.displaySmall)), 
                        
                      ],),
                        
                        // sizedBox(8),
                        // Text(widget.assessment.title2!, style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium), textAlign: TextAlign.center,), 
                        // sizedBox(8)
                      ],
                    ),
              ),
                  ...
                  children: <Widget>[
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(widget.feeling.feeling!, style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.displayMedium, color: Palette.black), textAlign: TextAlign.center, ), 
            ...
            // sizedBox(16),
             (widget.feeling.description!.length > 1) ? Container(
              // decoration: BoxDecoration(
                ...
                Column(
                  ...
                  children: <Widget>[
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text(widget.feeling.description!, style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium) ), 
                      ],
                    ),
                  ]
                ),
                ...
                Column(
                  ...
                  children: <Widget>[
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text(description2, style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium) ), 
...
// ),
                ...
                Column(
                  ...
                  children: <Widget>[
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text('Resources', style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium) ), 
                        MaterialButton(
                          child: Text("View", style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.bodyLarge, fontWeight: FontWeight.bold, color: Palette.white)),
                ...
                Column(
                  ...
                  children: <Widget>[
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text('Are you feeling ${widget.feeling.feeling}?', style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium) ), 
                        MaterialButton(
                          child: Text("Yes", style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.bodyLarge, fontWeight: FontWeight.bold, color: Palette.white)),
                          padding: const EdgeInsets.fromLTRB(24, 8, 24, 8),
                          color: Palette.black,
                          textColor: Palette.white,
                          splashColor: Palette.white,
                ...
                Column(
                  ...
                  children: <Widget>[
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text('Connect with Psychologist', style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium) ), 
                        MaterialButton(
                          child: Text("Schedule", style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.bodyLarge, fontWeight: FontWeight.bold, color: Palette.white)),
                          padding: const EdgeInsets.fromLTRB(24, 8, 24, 8),
                          color: Palette.black,
                          textColor: Palette.white,
                          splashColor: Palette.white,
                ...
                Column(
                  ...
                  children: <Widget>[
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text('Chat with Psychologist', style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium) ), 
                        MaterialButton(
                          child: Text("Chat now", style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.bodyLarge, fontWeight: FontWeight.bold, color: Palette.white)),
                          padding: const EdgeInsets.fromLTRB(24, 8, 24, 8),
                          color: Palette.black,
                          textColor: Palette.white,
                          splashColor: Palette.white,
            ...
            sizedBox(8),
             (description3.length > 1) ? Container(
              ...
              decoration: BoxDecoration(
                color: Color(0x66FFBFDA),
                border: Border.all(color: Color(0xFFFFBFDA)),
                // color: Color(0xFFFFFFFF),
                borderRadius: BorderRadius.circular(10),
                boxShadow: const [
                  BoxShadow(
                    // color: Colors.black26,
                    color: Color(0xCCFFBFDA),
                    // color: Color(0xFF080B23),
                    offset: Offset(0.0, 0.0),
                    blurRadius: 24.0,
                    spreadRadius: 0.3,
            ...
            //           crossAxisAlignment: CrossAxisAlignment.start,
            //           children: <Widget>[
            //             Text(widget.result.message1!, style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium) ), 
            //           ],
            //         ),
            //       ]
            //     ),
            ...
            //           crossAxisAlignment: CrossAxisAlignment.start,
            //           children: <Widget>[
            //             Text(widget.result.message2!, style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium) ), 
            //           ],
            //         ),
            //       ]
            //     ),
            ...
            Container(
                ...
                child: MaterialButton(
                        child: Text("Close", style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.bodyLarge)),
                        padding: const EdgeInsets.fromLTRB(24, 8, 24, 8),
            ...
            Container(
              ...
              child: Column(
                  ...
                  Container(
                    ...
                    child: 
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('Resources', style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleLarge, fontWeight: FontWeight.bold)),
                          Container(
                ...
                shrinkWrap: true,
                        ...
                        //   child: 
                            Container(
                              ...
                              child: AnyLinkPreview(
                                        ...
                                        titleStyle: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.bodyLarge, fontWeight: FontWeight.bold, color: Colors.blue.shade700, decoration: TextDecoration.underline, decorationColor: Colors.blue.shade700, ),
                                        bodyStyle: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.bodyLarge, color: Colors.black87),
                  ...
                  // Text(links[0], style: GoogleFonts.averiaGruesaLibre(textStyle: Theme.of(context).textTheme.titleMedium) ), 
                  sizedBox(64),
              ],)

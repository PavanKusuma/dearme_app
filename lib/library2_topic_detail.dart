...
import 'package:psych_app/library2_feeling_detail.dart';
...
import 'package:psych_app/modal/library.dart';
import 'package:psych_app/modal/library_detail.dart';
...
class LibraryDetail extends StatefulWidget {
  final Library feeling;

  LibraryDetail({required this.feeling});

  @override
  LibraryDetailState createState() => LibraryDetailState();
}

class LibraryDetailState extends State<LibraryDetail> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<LibraryDetail> {
...
// late GlobalKey<FormState> _formKey;
  ...
  List<LibraryDetails> list = [];
  List<LibraryDetails> oldList = [];
...
// print(Provider.of<SharedState>(context).isDataLoaded);
  ...
  void getFeelingData() async {
    ...
    if(await checkInternetConnectivity()){
      ...
      var result = await get(Uri.parse(APIUrls.getUrl("${APIUrls.library}${APIUrls.pass}/$role/$offset/2/9", queryParams)), headers: {"Accept": "application/json"});
      // print(result.body);
      // print(utf8.decode(result.bodyBytes));
      
      // get the result body which is JSON
      // var jsonString = utf8.decode(result.bodyBytes); 
      ...
      if(jsonObject['status'] == 200){
        ...
        if(requests.isNotEmpty){
          // convert to list
          list1 = requests.map<LibraryDetails>((json) => LibraryDetails.fromJson(json)).toList();
          ...
          if(list1.isNotEmpty){
            ...
            setState(() {
              ...
              feelings = list1[0].feeling!.split(',');
...
// Example HTML string
  ...
  return Scaffold(
      ...
      SafeArea(
        ...
        list.isEmpty ?
        Container(
          child: AppProgress(height: 36, width: 36),
        ) :
        ...
        Column(
          ...
          children: <Widget>[
                  ...
                  Column(
                    ...
                    children: [ 
                      Wrap(
                        ...
                        children: [
                        Text(widget.feeling.title!, style: GoogleFonts.dmSerifText(textStyle: Theme.of(context).textTheme.displaySmall)), 
            ...
            sizedBox(32),
            list.isNotEmpty ?
            (list[0].media!.length > 3) ?
                        Center(
                          child: Image.network(list[0].media!, height: 200,),
                        )
                        : sizedBox(0)
                        : AppProgress(height: 24, width: 24),

            // list of feelings associated with this title
            sizedBox(32),
            Row(
                  // mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  // children: <Widget>[
                    ...
                    InkWell(
                      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => LibraryFeelingDetail(feeling: feeling))),
                      child: Container(
                                margin: const EdgeInsets.fromLTRB(0, 0, 12, 0),
                                padding: const EdgeInsets.fromLTRB(12, 6, 8, 8),
                                decoration: BoxDecoration(
                            ...
                            Wrap(
                              ...
                              children: <Widget>[
                                Text(feeling, style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.titleMedium) ), 
                                Icon(PhosphorIconsRegular.arrowUpRight, color: Palette.black, size: 24,),
            ...
            Container(
                  ...
                  children: <Widget>[
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(list[0].description!, style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.bodyLarge, color: Palette.black) ), 
             ...
             sizedBox(16),
             (list[0].description!.length > 1) ? Container(
              // decoration: BoxDecoration(
                ...
                Column(
                  ...
                  children: <Widget>[
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text(list[0].description2!, style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.bodyLarge, color: Palette.black) ), 
                      ],
                    ),
                  ]
                ),
            ...
            sizedBox(16),
             (description3.length > 1) ? 
        //     SingleChildScrollView(
        // child: 
             Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: description3.map((desc) => Container(
                  decoration: BoxDecoration(
                    color: const Color(0x66DDC9FF),
                    border: Border.all(color: const Color(0xFFDDC9FF)),
                    // color: Color(0xFFFFFFFF),
                    borderRadius: BorderRadius.circular(10),
                    boxShadow: const [
                      BoxShadow(
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            RichText(text: htmlToTextSpan(desc),),
                          ],
                        ),
                      ]
                    ),
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Resources', style: GoogleFonts.dmSerifText(textStyle: Theme.of(context).textTheme.titleLarge)),
                sizedBox(8),
                ListView.builder(
                            ...
                            //   child: 
                                Container(
                                  ...
                                  child: AnyLinkPreview(
                                            ...
                                            boxShadow: [const BoxShadow(blurRadius: 3, color: Color(0xFFDDDDDD))],
...
void _showResources(BuildContext context){
    showModalBottomSheet(
      ...
      // backgroundColor: const Color(0xEEFFCEBF),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            InkWell(
                              ...
                              child: Icon(PhosphorIconsRegular.x, color: Colors.black87, size: 24,),
                            ),
                          ),
                        ],
                      ),

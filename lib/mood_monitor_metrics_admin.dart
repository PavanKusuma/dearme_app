...
import 'package:psych_app/modal/mood_admin.dart';
...
class MoodMonitorMetricsAdmin extends StatefulWidget {
  // final Assessment assessment;

  // MoodMonitorMetricsAdmin({required this.assessment});

  @override
  MoodMonitorMetricsAdminState createState() => MoodMonitorMetricsAdminState();
}

class MoodMonitorMetricsAdminState extends State<MoodMonitorMetricsAdmin> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<MoodMonitorMetricsAdmin> {
    ...
    if(await checkInternetConnectivity()){
      ...
      if(jsonObject['status'] == 200){
        ...
        if(requests.isNotEmpty){
          // convert to list
          list1 = requests.map<MoodAdmin>((json) => MoodAdmin.fromJson(json)).toList();
            ...
            setState(() {
              ...
              for (MoodAdmin mood in list) {
                ...
                //   moodCounts.update(mood.emotion!, (value) => value + 1, ifAbsent: () => 1);
                  totalCheckIns = totalCheckIns + mood.count!;
                  totalStudents = totalStudents + mood.collegeId!;
        ...
        child: Column(
          ...
          children: <Widget>[
             ...
             list.isNotEmpty ? Center(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                            Text('$totalStudents', style: GoogleFonts.dmSans(fontSize: 32, fontWeight: FontWeight.bold, color: Color(0xFF6302E5))), 
                            sizedBox(8),
                            Text('Students', style: GoogleFonts.dmSans(fontSize: 18, color: Colors.black87)), 
                            ],
                          )
                        ],
                      ),
                      ...
                      Center(
                        child: CustomPaint(
                          ...
                          painter: PieChartPainter(
                            percentages: [
                              list.any((moodAdmin) => moodAdmin.emotion == "Positive") ? list.firstWhere((moodAdmin) => moodAdmin.emotion == "Positive").count!.toDouble()/totalCheckIns : 0.0, 
                              list.any((moodAdmin) => moodAdmin.emotion == "Negative") ? list.firstWhere((moodAdmin) => moodAdmin.emotion == "Negative").count!.toDouble()/totalCheckIns : 0.0, 
                              list.any((moodAdmin) => moodAdmin.emotion == "Neutral") ? list.firstWhere((moodAdmin) => moodAdmin.emotion == "Neutral").count!.toDouble()/totalCheckIns : 0.0, ], // The percentages for the pie chart
              ...
              list.isEmpty ? AppProgress(height: 36, width: 36) :
                    ...
                    Column(
                      ...
                      children: list.map((entry) {
                          ...
                          Column(
                            ...
                            mainAxisSize: MainAxisSize.max,
                            children: [
                            // Text('${entry.emotion}', style: GoogleFonts.dmSans(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF000000))),
                            // sizedBox(8),
                            // Text('${entry.count} times', style: GoogleFonts.dmSans(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF000000))),
                            // sizedBox(8),
                            // Text('${entry.collegeId} student(s)', style: GoogleFonts.dmSans(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF000000))),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('${entry.emotion} ', style: GoogleFonts.dmSerifText(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF000000))),
                                sizedBox(16),
                                Text('Reported: ${entry.count} times', style: GoogleFonts.dmSans(fontSize: 20, fontWeight: FontWeight.w500, color: Color(0xFF000000))),
                                Text('Students: ${entry.collegeId}', style: GoogleFonts.dmSans(fontSize: 20, fontWeight: FontWeight.w500, color: Color(0xFF000000))),
                            ...
                            //           children: <Widget>[
                            //             Text('Students reported: ${entry.collegeId}', style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.titleMedium, color:  Color(0xFF000000) ) ), 

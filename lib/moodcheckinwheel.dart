...
class MoodCheckInWheel extends StatefulWidget {
  // final Assessment assessment;

  // MoodCheckInWheel({required this.assessment});

  @override
  MoodCheckInWheelState createState() => MoodCheckInWheelState();
}

class MoodCheckInWheelState extends State<MoodCheckInWheel> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin<MoodCheckInWheel> {
 ...
 Future<void> getFeelingsForEmotion(String emo) async {
  ...
  player.play();
    ...
    try {
      ...
      setState(() {
        ...
        selectedFeelings = mixedList.whereType<String>().toList();
  ...
  void saveMoodCheckInWheel() async {
    ...
    if(await checkInternetConnectivity()){
      ...
      var result = await get(Uri.parse(APIUrls.getUrl("${APIUrls.mood}${APIUrls.pass}/${DateFormat('yyyy-MM-dd HH:mm:ss', 'en_US').format(today)}/$campusId/$collegeId/$emotion/$selectedFeeling/${Uri.encodeComponent(descriptionController.text)}", queryParams)), headers: {"Accept": "application/json"});
      // print(result.body);
        ...
        child: Column(
          ...
          children: <Widget>[
               ...
               Row(
                ...
                children: [
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        color: (emotion == Constants.happy) ? Color(0x66FFC5F8) : Color(0x66FFFFFF),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            // Image.asset( 'assets/image1.png', width: 60, height: 60, ),
                                  sizedBox(16),
                            Text('Happy', style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.titleLarge, fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ),
                    )
            ...
            Expanded(
               ...
               InkWell(
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        color: (emotion == Constants.sad) ? Color(0x66FFC5F8) : Color(0x66FFFFFF),
                        border: Border.all(color: const Color(0xFFFFFFFF)),
                        borderRadius: BorderRadius.circular(10),
                        boxShadow: const [
                          BoxShadow(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            // Image.asset( 'assets/image2.png', width: 60, height: 60, ),
                                  sizedBox(16),
                            Text('Sad', style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.titleLarge, fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ),
                    )
            ...
            Expanded(
               ...
               InkWell(
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        color: (emotion == Constants.fear) ? Color(0x66FFC5F8) : Color(0x66FFFFFF),
                        border: Border.all(color: const Color(0xFFFFFFFF)),
                        borderRadius: BorderRadius.circular(10),
                        boxShadow: const [
                          BoxShadow(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            // Image.asset( 'assets/image3.png', width: 60, height: 60, ),
                                  sizedBox(16),
                            Text('Fear', style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.titleLarge, fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ),
                    )
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    InkWell(
                        onTap: () {
                            setState(() {
                              getFeelingsForEmotion(Constants.disgust);
                              emotion = Constants.disgust;
                            });
                          },             
                        child: Container(
                          margin: const EdgeInsets.fromLTRB(16,0,8,16),
                          padding: const EdgeInsets.all(16),
                            decoration: BoxDecoration(
                              color: (emotion == Constants.disgust) ? Color(0x66FFC5F8) : Color(0x66FFFFFF),
                              border: Border.all(color: const Color(0xFFFFFFFF)),
                              borderRadius: BorderRadius.circular(10),
                              boxShadow: const [
                                BoxShadow(
                          ...
                          child: 
                              Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: <Widget>[
                                  // Image.asset( 'assets/image4.png', width: 60, height: 60, ),
                                  sizedBox(16),
                                  Text('Disgust', style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.titleLarge, fontWeight: FontWeight.w600)),
                                  ],
                                ),
                          )
                        )),
                  ...
                  Expanded(
                    ...
                    InkWell(
                      onTap: () {
                            setState(() {
                              getFeelingsForEmotion(Constants.anger);
                              emotion = Constants.anger;
                            });
                          },             
                        child: Container(
                          margin: const EdgeInsets.fromLTRB(8,0,8,16),
                          padding: const EdgeInsets.all(16),
                            decoration: BoxDecoration(
                              color: (emotion == Constants.anger) ? Color(0x66FFC5F8) : Color(0x66FFFFFF),
                              border: Border.all(color: const Color(0xFFFFFFFF)),
                              borderRadius: BorderRadius.circular(10),
                              boxShadow: const [
                                BoxShadow(
                          ...
                          child:   Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: <Widget>[
                                  // Image.asset( 'assets/image5.png', width: 60, height: 60, ),
                                  sizedBox(16),
                                  Text('Anger', style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.titleLarge, fontWeight: FontWeight.w600)),
                                  ],
                                ),
                          )
                        )),
                  ...
                  Expanded(
                    ...
                    InkWell(
                        onTap: () {
                            setState(() {
                              getFeelingsForEmotion(Constants.surprise);
                              emotion = Constants.surprise;
                            });
                          },             
                        child: Container(
                          margin: const EdgeInsets.fromLTRB(8,0,16,16),
                          padding: const EdgeInsets.all(16),
                            decoration: BoxDecoration(
                              color: (emotion == Constants.surprise) ? Color(0x66FFC5F8) : Color(0x66FFFFFF),
                              border: Border.all(color: const Color(0xFFFFFFFF)),
                              borderRadius: BorderRadius.circular(10),
                              boxShadow: const [
                                BoxShadow(
                          ...
                          child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: <Widget>[
                                  // Image.asset( 'assets/image6.png', width: 60, height: 60, ),
                                  sizedBox(16),
                                  Text('Surprise', style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.titleLarge, fontWeight: FontWeight.w600)),
                                  ],
                                ),
                          )
                        )),
            ...
            Column(
              children: [
                sizedBox(16),
                Text('Reason for this emotion?', style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.bodyMedium), textAlign: TextAlign.center,), 
                sizedBox(8),
                Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          items: selectedFeelings.map<DropdownMenuItem<String>>((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(value, style: GoogleFonts.dmSans(textStyle: Theme.of(context).textTheme.bodyLarge),),
                            );
                          }).toList(),
                        ),
                      ),
            ...
            //                   Container(
            //                     alignment: Alignment.center,
            //                     child: Text('No questions available!', style: GoogleFonts.inter(textStyle: Theme.of(context).textTheme.bodyText2)), 
            //                 ),
            //                 sizedBox(8),
            ...
            Column(
              children: [
                ...
                Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:  'Note down why you are feeling '+selectedFeeling,
                          ...
                          validator: (value) { // validator function is called on calling form validate() method
                            if (value!.isEmpty) {
                              return 'Note down why you are feeling '+selectedFeeling;
                            }
                            return null;
                          },
                ...
                sizedBox(32),
                (selectedFeeling.isNotEmpty) ? Container(
                    alignment: Alignment.center,
                    child: 
                    // loader while fetching data
